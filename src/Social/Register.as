package Social {
	...
	public class Register extends Sprite {
		...
		public function Register() {
			...
			field_description.textColor = field_email.textColor = field_name.textColor = field_password.textColor = Theme.text_color;
			field_description.embedFonts = field_email.embedFonts = field_name.embedFonts = field_password.embedFonts = true;
			field_description.selectable = false;
			field_description.type = TextFieldType.DYNAMIC;
			field_email.selectable = field_name.selectable = field_password.selectable = true;
			...
			field_email.height = field_name.height = field_password.height = 16;
			field_email.background = field_name.background = field_password.background = true;
			field_email.backgroundColor = field_name.backgroundColor = field_password.backgroundColor = Theme.back_color;
		...
		private function register_action(e:Event = null):void {
			...
			variables.email = field_email.text;
