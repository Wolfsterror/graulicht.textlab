package Dialogs {
	...
	public class ThemeSelector extends Sprite {
		...
		public function ThemeSelector() {
			...
			button_theme_lime = new Button('Limette', theme_lime);
			this.addChild(button_theme_lime);
		...
		private function draw():void {
			...
			button_theme_lime.x = button_theme_eisfuchslabor.width + 4;
			button_theme_lime.y = 0;
			button_theme_contrast.x = button_theme_lime.width + button_theme_eisfuchslabor.width + 4 * 2;
			...
			button_close.y = button_theme_textlab.height + button_theme_lime.height + 4 * 2;
		...
		private var button_theme_lime:Button;
		...
		private function theme_lime(e:Event = null):void {
			Theme.theme_lime();
			refresh();
		}
