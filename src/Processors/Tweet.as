package Processors {
	...
	/**
	 * This emits the last Tweet the Twitter user @eiszfuchs sent.
	 *
	 * @author Raphael Pohl
	 */
	public class Tweet extends Processor {
		...
		public function Tweet() {
			...
			// pay attention to the button option. It is very useful.
			_options = [
				{ name: "refresh", label: Language.words['refresh'], type: "button", action: function():void {
		...
		public var _value:String = new String;
